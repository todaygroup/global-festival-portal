...
def main():
    # High-quality city list for Germany
    cities = [
        ...
        "Stuttgart", "Ulm", "Heidenheim", "Reutlingen", "Tübingen", "Boden//", "Biberach", "Ravensburg", "Friedrichshafen", "Weissach",
        ...
        "Hanover", "Wolfsburg", "Braunschweig", "Hildesheim", "Goslar", "Hameln", " Göttingen", "Einbeck", "Einbeck", "Hameln",
    ...
    unique_cities = sorted(list(set([c.strip() for c in cities if c.strip()])))
    ...
    for city in unique_cities:
        for f_type, url_template in festival_types:
            # Avoid adding the same festival if it's already in the major list
